...
function skus() {
    ...
    $("tr[class*='sku_table_tr']").each(function (i, item) {
        let newObj = {}
        var skuSellPrice = $(this).find("input[type='text'][class*='setting_sku_price']").val() || 0;//SKU销售价格
        console.log('skuSellPrice', skuSellPrice)
        var skuMarketPrice = $(this).find("input[type='text'][class*='setting_sku_price']").val() || 0;//SKU销售价格
